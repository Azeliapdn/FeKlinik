    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/admin">
          ...
          />
          <Route
            path="specialization/edit/:specializationId"
          ...
          <Route
            path="doctor-umum/edit/:doctorId"
          ...
          />
          <Route
            path="schedule/specialization/create"
            Component={CreateScheduleSpecializationPage}
          />
          <Route
            path="schedule/specialization/edit/:scheduleSpecializationId"
            Component={EditScheduleSpecializationPage}
          />
          <Route
            path="schedule/general"
            Component={ScheduleGeneralManagementPage}
          />
          <Route
            path="schedule/general/create"
            Component={CreateScheduleGeneralPage}
          />
          <Route
            path="schedule/general/edit/:scheduleGeneralId"
